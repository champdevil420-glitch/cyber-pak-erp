...
import { 
  ...
  Wallet, Scale, Activity, Search, Package
} from "lucide-react";
  ...
  const navGroups: NavGroup[] = [
    ...
    },
    {
      ...
      links: [
        ...
        { name: "Inventory (In/Out)", href: "/inventory", icon: Package }, // ADDED THIS
                  ...
                  {group.links.map((link, lIdx) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        {link.alert && <span className="bg-red-600 text-white text-[7px] px-1.5 py-0.5 rounded-full">{link.alert}</span>}
                      </Link>
                    );
                  })}
                </div>
